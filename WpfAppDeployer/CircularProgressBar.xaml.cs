...
namespace WpfAppDeployer
{
    ...
    public partial class CircularProgressBar
    {
        ...
        /// Sets the position.
        /// </summary>
        /// <param mName="ellipse">The ellipse.</param>
        /// <param mName="offset">The offset.</param>
        /// <param mName="posOffSet">The pos off set.</param>
        /// <param mName="step">The step to change.</param>
        ...
        /// </summary>
        /// <param mName="sender">The sender.</param>
        /// <param mName="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
        ...
        /// </summary>
        /// <param mName="sender">The sender.</param>
        /// <param mName="e">The <see cref="System.Windows.RoutedEventArgs"/> instance containing the event data.</param>
        ...
        /// </summary>
        /// <param mName="sender">The sender.</param>
        /// <param mName="e">The <see cref="System.Windows.DependencyPropertyChangedEventArgs"/> instance containing the event data.</param>
