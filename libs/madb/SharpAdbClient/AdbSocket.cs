...
namespace SharpAdbClient
{
    ...
    public class AdbSocket : IAdbSocket, IDisposable
    {
        ...
        public async Task<int> ReceiveAsync(byte[] header, int offset, int size, SocketFlags socketFlags, CancellationToken cancellationToken)
        {
            return await this.socket.ReceiveAsync(header, offset, size, socketFlags, cancellationToken);
        }
    }
}
